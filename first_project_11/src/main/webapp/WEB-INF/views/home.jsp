...
<body>
    ...
    <main>
                        ...
                        <div class="row d-flex align-items-center">
                            <div class="col-lg-6 col-md-9 ">
                                <div class="hero__caption">
                                    <span data-animation="fadeInUp" data-delay=".4s">TEAM 2</span>
                                    <h1 data-animation="fadeInUp" data-delay=".6s">CONTENTS REVIEW BOARD<br></h1>
                                    <p data-animation="fadeInUp" data-delay=".8s">환영합니다 ! 영화, TV 프로그램을 포함한 여러 컨텐츠에 관한 리뷰를 여기서 볼 수 있습니다.</p>
                                    
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="hero__img d-none d-lg-block f-right" data-animation="fadeInRight" data-delay="1s">
                                    <img src="/resources/assets/img/hero/hero_right.png" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="customar-active dot-style d-flex dot-style">
                                <div class="single-customer mb-100">
                                    <div class="what-img">
                                        <img src="/resources/assets/img/shape/man3.png" alt="">
                                    </div>
                                    <div class="what-cap">
                                        <h4><a href="#">김성환</a></h4>
                                        <p>프로그램 상세보기<br>이미지 업로드<br>좋아요 목록 불러오기</p>
                                    </div>
                                </div>
                            
                                <div class="single-customer mb-100">
                                    <div class="what-img">
                                        <img src="/resources/assets/img/shape/man2.png" alt="">
                                    </div>
                                    <div class="what-cap">
                                        <h4><a href="#">김민수(남)</a></h4>
                                        <p>프로그램 수정<br>댓글 수정</p>
                                    </div>
                                </div>
                            
                                <div class="single-customer mb-100">
                                    <div class="what-img">
                                        <img src="/resources/assets/img/shape/man1.png" alt="">
                                    </div>
                                    <div class="what-cap">
        ...
        <div class="say-something-aera pt-90 pb-90 fix">
                ...
                <div class="row justify-content-between align-items-center">
                    <div class="offset-xl-1 offset-lg-1 col-xl-5 col-lg-5">
                        <div class="say-something-cap">
                            <h2>Github에 파일을 <br>업로드하였습니다.</h2>
                        </div>
                    </div>
                    <div class="col-xl-2 col-lg-3">
                        <div class="say-btn">
                            <a href="https://github.com/kimxminsu/reviewboard-springboot" class="btn radius-btn">깃허브 이동</a>
                        </div>
                    </div>
                </div>
            </div>
            <!-- shape -->
            <div class="say-shape">
                <img src="/resources/assets/img/shape/say-shape-left.png" alt="" class="say-shape1 rotateme d-none d-xl-block">
                <img src="/resources/assets/img/shape/say-shape-right.png" alt="" class="say-shape2 d-none d-lg-block">
            </div>
        </div>
        <!-- Say Something End -->
